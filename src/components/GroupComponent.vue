...
<template>
<div class="flex flex-row max-w-md w-full group truncate">
    <div class="h-full group-header flex items-center justify-center">
        <h1 class="vertical">GROUP {{group}}</h1>
    </div>
    <table class="w-full">
        <tr>
            <th>SEED</th>
            <th class="w-96 min-w-sm">TEAM NAME</th>
            <th>A</th>
            <th>B</th>
            <th>C</th>
            <th>D</th>
